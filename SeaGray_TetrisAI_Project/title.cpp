...
Title::Title(const InitData& init)
	...
	m_exitB = Rect{ Point(100, 650), 160, 50};
...
void Title::update()
{
	...
	if (SimpleGUI::Button(U"Bot initializing", Vec2{ 60, 120 }, unspecified)) {
	...
	if (SimpleGUI::Button(U"AI starting", Vec2{ 60, 180 }, unspecified)) {
	...
	if (SimpleGUI::Button(U"AI stopping", Vec2{ 60, 240 }, unspecified)) {
		if (connect_state == 1) {
			StartFlag = false;
		}
	}
